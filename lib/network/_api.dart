...
//
//   API({required this.key, required this.type, required this.maxResults, this.query});
//
...
//   }
//
//   Uri searchUri(query, {required String? type}) {
//     this.query = query;
...
//     this.order = order ?? 'date';
//     this.channelId = channelId;
//     var options = getChannelOption(channelId, order!);
